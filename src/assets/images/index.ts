const imagePaths = {
  ...
  location_filled: require('./location_filled.png'),
  ...
  calender_icon1: require('./calender_icon1.png'),
  ...
  empty_image: require('./empty_image.png'),
  placeholder_img: require('./placeholder_img.png'),
  user0: require('./user0.jpg'),
  ...
  share_profile: require('./share_profile.png'),
  edit_pencil: require('./edit_pencil.png'),
  ...
  totalbooking: require('./totalbooking.png'),
  totalservices: require('./totalservices.png'),
  totalearning: require('./totalearning.png'),
  ...
  Edit_gray: require('./Edit_gray.png'),
  Delete_gray: require('./Delete_gray.png'),
  upload_icon: require('./upload_icon.png'),
